-- fix-workflow-schema.sql
-- 위치: /Users/leesg/Documents/work_ops/automation-system/scripts/
...
-- 2. workflow_steps 테이블 수정
-- Foreign Key 제약 조건 제거 (execution_id 타입 변경을 위해)
ALTER TABLE workflow_steps
DROP CONSTRAINT IF EXISTS workflow_steps_execution_id_fkey;
...
-- workflow_steps 테이블 인덱스
DROP INDEX IF EXISTS idx_workflow_steps_execution_id;
CREATE INDEX idx_workflow_steps_execution_id 
